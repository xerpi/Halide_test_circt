...
create_project -force kernel_pack "./project"

# Add all Verilog files in the current working directory.
add_files -norecurse [glob *.v *.sv]

# I don't really understand any of this.
ipx::package_project -root_dir $path_to_packaged -vendor halide-lang.org -library Halide -taxonomy /KernelIP -import_files -set_current false
ipx::unload_core $path_to_packaged/component.xml
ipx::edit_ip_in_project -upgrade true -name tmp_edit_project -directory $path_to_packaged $path_to_packaged/component.xml
set_property sdx_kernel true [ipx::current_core]
set_property sdx_kernel_type rtl [ipx::current_core]

# In case there's more than clock, we must infer ap_clk as an AXI bus signal.
