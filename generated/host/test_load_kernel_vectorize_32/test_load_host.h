#ifndef HALIDE__test_load_host_h
#define HALIDE__test_load_host_h
#include <stdint.h>
...
int test_load(struct halide_buffer_t *_p0_buffer, struct halide_buffer_t *_f1_buffer);

HALIDE_FUNCTION_ATTRS
int test_load_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *test_load_metadata();
